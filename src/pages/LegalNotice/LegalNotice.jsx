...
const LegalNotice = () => {
  <div>
    <h1>Mentions légales En vigueur au 09/02/2024</h1>
    ...
    <p>
      ...
      visiteurs, ci-après l""Utilisateur", du site www.kidi-link.fr , ci-après
      le "Site", les présentes mentions légales. La connexion et la navigation
      sur le Site par l’Utilisateur implique acceptation intégrale et sans
      réserve des présentes mentions légales. Ces dernières sont accessibles sur
      le Site à la rubrique « Mentions légales ». ARTICLE 1 - L'EDITEUR
      L’édition et la direction de la publication du Site est assurée par Team
      Kidilink, domiciliée 1 Avenue React et Symfo 75001 OCLOCK, dont le numéro
      de téléphone est 0102030405, et l'adresse e-mail contact@kidi-link.fr.
      ci-après l'"Editeur".
    </p>
    ...
    <p>
      L'hébergeur du Site est la société OCLOCK, dont le siège social est situé
      au _______________ , avec le numéro de téléphone : _______________ +
    ...
    <p>
      ...
      exerce ce droit : · par mail à l'adresse email contact@kidi-link.fr Toute
      utilisation, reproduction, diffusion, commercialisation, modification de
      toute ou partie du Site, sans autorisation de l’Editeur est prohibée et
