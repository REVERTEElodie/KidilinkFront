...
const LegalNotice = () => {
  return (
    <Container>
      <h2>Mentions légales En vigueur au 09/02/2024</h2>
      ...
      <p>
        ...
        sur le Site à la rubrique « Mentions légales ». ARTICLE 1 - L'EDITEUR
        L’édition et la direction de la publication du Site est assurée par Team
        Kidilink, domiciliée 1 Avenue React et Symfo 75001 OCLOCK, dont le
        numéro de téléphone est 0102030405, et l'adresse e-mail
        contact@kidi-link.fr. ci-après l'"Editeur".
      </p>

      <h3>ARTICLE 2 - L'HEBERGEUR</h3>

      <p>
        L'hébergeur du Site est la société OCLOCK, dont le siège social est
        situé au _______________ , avec le numéro de téléphone : _______________
      ...
      <p>
        ...
        : · par mail à l'adresse email contact@kidi-link.fr Toute utilisation,
